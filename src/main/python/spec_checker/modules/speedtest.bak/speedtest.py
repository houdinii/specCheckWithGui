...
# THIS IS THE BEGINNING OF MODIFIED CODE
# IT IS REPLACING CODE FROM LINE 1175
from .config import ignore_servers as ignored_servers

IGNORE_SERVERS_FROM_CONFIG = ignored_servers
def get_ignore_list():
    is_list = []
    if len(IGNORE_SERVERS_FROM_CONFIG) > 0:
        is_list = IGNORE_SERVERS_FROM_CONFIG
    return is_list
# END CUSTOM CODE
...
def print_dots(shutdown_event):
    ...
    def inner(current, total, start=False, end=False):
        ...
        sys.stdout.write('custom_speedtest')
...
class Speedtest(object):
    ...
    def get_config(self):
        ...
        # )
        ignore_servers = get_ignore_list()
