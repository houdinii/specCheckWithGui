...
# fixme This might need to be commented out:
# ET = None
FakeSocket = None
            ...
            if ssl:
                try:
                    ...
                    try:
                        ...
                        pass
            # fixme This entire elif might be able to comment out
            elif FakeSocket:
                ...
                # fixme This entire else might be able to comment out
                raise SpeedtestException(
                    'This version of Python does not support HTTPS/SSL '
                    'functionality'
                )
...
# noinspection HttpUrlsUsage,PyShadowingNames
